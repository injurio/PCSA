...
boot:
    mov si, prompt     ; Point SI register to our prompt buffer
...
.clear_buffer:
    ...
    mov ah, 0x0e         ; Set AH register to 0x0e to specify 'int 10h' 'teletype output' function
...
print_greeting:
    mov si, new_line    ; Point SI register to the new line buffer
    call print_message  ; Call our string-printing routine to print a new line
